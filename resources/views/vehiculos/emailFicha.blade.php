...
@section('contenido')
    <div class="container">
        <h2 style="font-family: 'Roboto', sans-serif;">Contactar por correo.</h2>
        ...
        <form id="emailForm" action="{{ route('enviarCorreoPropietario') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="description" name="description" rows="5" style="resize: vertical;" required>
